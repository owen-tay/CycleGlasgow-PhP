...
<head>
    ...
    <!-- Include your head modules here -->
            ...
            <div class="w-full p-8">
                ...
                <form method="POST" name="login_form" action="<?php echo strip_tags(htmlentities($_SERVER["PHP_SELF"])); ?>">
                    <div class="mb-4">
                        ...
                        <input class="block w-full border border-gray-300 rounded py-2 px-3" type="text" id="username" name="username" placeholder="johnsmith" required>
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-semibold mb-2" for="password">Password</label>
                        <input class="block w-full border border-gray-300 rounded py-2 px-3" type="password" id="password" name="password" placeholder="************" required>
                    </div>
                    <div class="mb-6">
                        <p class="text-red-500 text-xs"><?php echo $errorMsg; ?></p>
                        <button type="submit" name="submit" class="bg-gradient-to-r from-pink-cycle to-blue-cycle w-full py-2 text-white rounded">Sign In</button>
                    </div>
                </form>
                <p class="text-blue-cycle text-center">
                    If you need an account, <a href="register-start.php" class="text-pink-cycle"><span>click here</span></a>
                </p>
            </div>
        </div>
    </div>
