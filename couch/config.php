<?php
    ...
    //define( 'K_SITE_URL', 'https://cycleglagow.yupstuff.net/' );
    ...
    define( 'K_DB_NAME', 'u785699759_couch' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'u785699759_cmsusername' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'Cmsloginpassword1!' );
    // 7.
    ...
    define( 'K_EMAIL_TO', 'owen.taylordev@googlemail.com' );
